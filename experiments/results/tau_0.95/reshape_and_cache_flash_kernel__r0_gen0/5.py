...
def reshape_and_cache_flash(
    ...
    # Dynamically adjust CHUNK_ELEMENTS to reduce loop-control scalar overhead.
    # Keep the tail mask in the kernel for full logical-domain coverage.
    if n <= 8192:
        CHUNK_ELEMENTS = n
    else:
        # Use 8192 as the larger default tile; 16384 may be considered only
        # after verifying UB capacity and occupancy impact.
        CHUNK_ELEMENTS = 8192
