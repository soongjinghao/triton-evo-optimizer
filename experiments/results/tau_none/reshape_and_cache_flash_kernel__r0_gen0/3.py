...
def reshape_and_cache_flash_kernel(
    ...
    token_key_base = key + token_idx * key_stride
    token_value_base = value + token_idx * value_stride
    ...
    for chunk_idx in range(0, num_chunks):
        ...
        k = tl.load(token_key_base + offset + chunk_i, mask=chunk_mask)
        v = tl.load(token_value_base + offset + chunk_i, mask=chunk_mask)
