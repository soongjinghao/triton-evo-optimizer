...
def merge_16x16_to_32x32_inverse_kernel(
    ...
    nrows = T - chunk_start
    limit1 = tl.minimum(16, nrows)
    limit2 = tl.minimum(32, nrows)
    ...
    base_A_11 = A + chunk_start * H * BT + o_i
    base_A_22 = base_A_11 + 16

    for i in range(2, limit1):
        b_a_11 = -tl.load(base_A_11 + i * H * BT)
        b_a_11 += tl.sum(b_a_11[:, None] * b_Ai_11, 0)
        b_Ai_11 = tl.where((o_i == i)[:, None], b_a_11, b_Ai_11)

    for i in range(18, limit2):
        b_a_22 = -tl.load(base_A_22 + i * H * BT)
