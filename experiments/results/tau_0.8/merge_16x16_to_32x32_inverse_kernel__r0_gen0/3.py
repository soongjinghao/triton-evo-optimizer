...
def merge_16x16_to_32x32_inverse_kernel(
    ...
    addr11 = base11 + 2 * H * BT
    for k in range(2, limit1):
    ...
    addr22 = base22 + 18 * H * BT
    for k in range(18, limit2):
        b_a_22 = -tl.load(addr22)
        b_a_22 += tl.sum(b_a_22[:, None] * b_Ai_22, 0)
        b_Ai_22 = tl.where((o_i == k - 16)[:, None], b_a_22, b_Ai_22)
        addr22 += H * BT
