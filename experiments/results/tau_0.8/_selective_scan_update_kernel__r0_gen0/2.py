...
def selective_state_update(
    ...
    stride_state_dstate_is_one = state.stride(3) == 1
    stride_B_dstate_is_one = B.stride(2) == 1
    stride_C_dstate_is_one = C.stride(2) == 1
    ...
    _selective_scan_update_kernel[grid](
        ...
        *(D.stride(0), D.stride(1)) if D is not None else (0, 0),
        ...
        tie_hdim,
        BLOCK_SIZE_M,
        stride_state_dstate_is_one,
        stride_B_dstate_is_one,
        stride_C_dstate_is_one,
        num_warps=num_warps,
    )