...
def fn_triton_kernel(
    ...
    head_offs_k_3d = head_offs_k[None, :, None]
    token_offs_k = token_id[:, None, None] * K_STRIDE_0
    offs_k_nope = (
        token_offs_k
        + head_offs_k_3d
        + nope_sub_id[None, None, :]
    ...
    token_offs_rope = token_id[:, None, None] * K_ROPE_STRIDE_0
    offs_rope = token_offs_rope + rope_sub_id[None, None, :]
    offs_k_rope = (
        token_offs_k
        + head_offs_k_3d
