...
def fn_triton_kernel(
    ...
    head_id_3d = head_id[None, :, None]

    nope_sub_id = tl.arange(0, QK_NOPE_HEAD_DIM)
    offs_nope = (
        token_id_3d * K_NOPE_STRIDE_0
        + head_id_3d * K_NOPE_STRIDE_1
        + nope_sub_id[None, None, :]
    )

    offs_k_base = token_id_3d * K_STRIDE_0 + head_id_3d * K_STRIDE_1
    offs_k = offs_k_base + nope_sub_id[None, None, :]
    ...
    offs_rope = token_id_3d * K_ROPE_STRIDE_0 + rope_sub_id[None, None, :]
    offs_k = offs_k_base + rope_sub_id[None, None, :] + QK_NOPE_HEAD_DIM
