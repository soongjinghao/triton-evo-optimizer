...
def fn_triton_kernel(
    ...
    offs_k = token_head_base + rope_sub_id[None, None, :] + QK_NOPE_HEAD_DIM
...
def fn_triton(k, k_nope, k_rope, qk_nope_head_dim, qk_rope_head_dim, num_local_heads):
    ...
    BLOCK_ROWS = 16
    BLOCK_HEADS = 16
    num_head_blocks = triton.cdiv(num_local_heads, BLOCK_HEADS)
    grid = (triton.cdiv(num_tokens, BLOCK_ROWS) * num_head_blocks,)
