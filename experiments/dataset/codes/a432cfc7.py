...
def fused_qkvzba_split_reshape_cat_kernel(
    ...
    q_vals = tl.load(base_ptr + tl.arange(0, HEAD_QK))
    k_vals = tl.load(base_ptr + tl.arange(HEAD_QK, HEAD_QK * 2))
    v_vals = tl.load(base_ptr + tl.arange(HEAD_QK * 2, HEAD_QK * 2 + NUM_HEADS_V_PER_QK * HEAD_V))
    z_vals = tl.load(base_ptr + tl.arange(HEAD_QK * 2 + NUM_HEADS_V_PER_QK * HEAD_V, HEAD_QK * 2 + NUM_HEADS_V_PER_QK * HEAD_V * 2))
    ...
    b_vals = tl.load(ba_base_ptr + tl.arange(0, NUM_HEADS_V_PER_QK))
    a_vals = tl.load(ba_base_ptr + tl.arange(NUM_HEADS_V_PER_QK, NUM_HEADS_V_PER_QK * 2))
