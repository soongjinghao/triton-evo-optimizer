...
def fused_qkvzba_split_reshape_cat_kernel(
    ...
    if i_bs_block < FULL_BS_BLOCKS:
        for b_offset in range(BLOCK_B):
            ...
            qkvz_row_ptr = mixed_qkvz + b_idx * NUM_HEADS_QK * QKVZ_DIM_T + i_qk * QKVZ_DIM_T
            q_row_ptr = mixed_qkv + b_idx * NUM_HEADS_QK * QKV_DIM_T + i_qk * HEAD_QK
            k_row_ptr = mixed_qkv + b_idx * NUM_HEADS_QK * QKV_DIM_T + NUM_HEADS_QK * HEAD_QK + i_qk * HEAD_QK
            v_row_ptr = mixed_qkv + b_idx * NUM_HEADS_QK * QKV_DIM_T + NUM_HEADS_QK * HEAD_QK * 2 + i_qk * HEAD_V * NUM_HEADS_V_PER_QK
            z_row_ptr = z + b_idx * NUM_HEADS_V * HEAD_V + i_qk * HEAD_V * NUM_HEADS_V_PER_QK
            ba_row_ptr = mixed_ba + b_idx * NUM_HEADS_QK * BA_DIM_T + i_qk * BA_DIM_T
            b_row_ptr = b + b_idx * NUM_HEADS_V + i_qk * NUM_HEADS_V_PER_QK
            a_row_ptr = a + b_idx * NUM_HEADS_V + i_qk * NUM_HEADS_V_PER_QK
