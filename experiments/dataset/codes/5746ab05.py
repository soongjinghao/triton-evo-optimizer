...
def _act_quant_kernel(
    ...
    if round_scale:
        amax_scaled = amax * fp8_max_inv
        log_val = tl.extra.cuda.libdevice.log2(amax_scaled)
        log_ceil = tl.extra.cuda.libdevice.ceil(log_val)
        scale = tl.extra.cuda.libdevice.exp2(log_ceil)
    else:
