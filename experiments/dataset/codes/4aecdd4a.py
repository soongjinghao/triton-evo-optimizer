...
def _act_quant_kernel(
    ...
    row_stride = BLOCK_M * groups_per_row
    row_start = (pid * BLOCK_M // groups_per_row) * BLOCK_M
    col_start = (pid * BLOCK_M % groups_per_row) * group_size
    ...
    s_cols = col_start // group_size
    s_ptrs = S_ptr + rows * groups_per_row + s_cols
    s_mask = row_mask
...
def act_quant(
    ...
    BLOCK_M = 32
    BLOCK_N = block_size
    groups_per_row = N // block_size
    grid = (triton.cdiv(M * groups_per_row, BLOCK_M * groups_per_row), 1)
