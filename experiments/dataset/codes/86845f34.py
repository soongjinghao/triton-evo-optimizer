...
def fn_triton_kernel(
    ...
    token_mask_3d = token_mask[:, None, None]
    mask = token_mask_3d & head_mask[None, :, None]
    ...
    nope_base = token_id[:, None, None] * K_NOPE_STRIDE_0 + head_offs_nope[None, :, None]
    k_base = token_id[:, None, None] * K_STRIDE_0 + head_offs_k[None, :, None]

    offs_nope = nope_base + nope_sub_id[None, None, :]
    offs_k_nope = k_base + nope_sub_id[None, None, :]
    ...
    offs_k_rope = k_base + rope_sub_id[None, None, :] + QK_NOPE_HEAD_DIM
