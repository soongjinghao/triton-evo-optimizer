...
def recompute_w_u_fwd_kernel(
    ...
    w_base = bos_h * K
    a_base = bos_h * BT
    k_base = (bos * Hg + head_group_idx) * K
    p_beta = tl.make_block_ptr(
        beta + bos_h, (T_local,), (H,), (i_t_local * BT,), (BT,), (0,)
    )
    p_g = tl.make_block_ptr(
        g + bos_h, (T_local,), (H,), (i_t_local * BT,), (BT,), (0,)
    )
    p_A = tl.make_block_ptr(
        A + a_base, (T_local, BT), (H * BT, 1), (i_t_local * BT, 0), (BT, BT), (1, 0)
    )
