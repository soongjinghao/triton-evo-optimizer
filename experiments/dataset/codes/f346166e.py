...
def fused_qkvzba_split_reshape_cat_kernel(
    ...
    for b_offset in range(BLOCK_B):
        ...
        if b_idx < TOTAL_BATCH:
            row_mixed_qkvz = mixed_qkvz + b_idx * NUM_HEADS_QK * QKVZ_DIM_T
            row_mixed_qkv = mixed_qkv + b_idx * NUM_HEADS_QK * QKV_DIM_T
            row_z = z + b_idx * NUM_HEADS_V
            row_mixed_ba = mixed_ba + b_idx * NUM_HEADS_QK * BA_DIM_T
            row_b = b + b_idx * NUM_HEADS_V
            row_a = a + b_idx * NUM_HEADS_V

            for i_qk in range(NUM_HEADS_QK):
                base_ptr = row_mixed_qkvz + i_qk * QKVZ_DIM_T
                ...
                blk_q_st_ptr = row_mixed_qkv + i_qk * HEAD_QK
                blk_k_st_ptr = row_mixed_qkv + NUM_HEADS_QK * HEAD_QK + i_qk * HEAD_QK
                blk_v_st_ptr = row_mixed_qkv + NUM_HEADS_QK * HEAD_QK * 2 + i_qk * HEAD_V * NUM_HEADS_V_PER_QK
                ...
                blk_z_st_ptr = row_z + i_qk * HEAD_V * NUM_HEADS_V_PER_QK
                tl.store(blk_z_st_ptr + tl.arange(0, HEAD_V * NUM_HEADS_V_PER_QK), z_vals)

                ba_base_ptr = row_mixed_ba + i_qk * BA_DIM_T
                ...
                blk_b_st_ptr = row_b + i_qk * NUM_HEADS_V_PER_QK
                blk_a_st_ptr = row_a + i_qk * NUM_HEADS_V_PER_QK
