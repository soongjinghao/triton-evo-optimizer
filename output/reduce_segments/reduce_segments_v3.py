...
def reduce_segments(
    ...
    query_token_idx = linear_id // num_query_heads
    query_head_idx = linear_id % num_query_heads
    ...
    if act_num_segments == NUM_SEGMENTS_PER_SEQ:
        ...
        segm_output = tl.load(segm_output_ptr + segm_output_offset, mask=dim_mask[None, :], other=0.0)
