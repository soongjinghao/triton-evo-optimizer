...
def _quantize_k_cache_fast_kernel(
    ...
    GROUPS: tl.constexpr = BLOCK_N // GROUP_SIZE

    if raw_block_id < NOPE_GRID_BLOCKS:
        effective_block_id = raw_block_id * GROUPS
        ...
        y_2d = tl.view(y, (GROUPS, GROUP_SIZE))
        ...
        offs_s = effective_block_id + tl.arange(0, GROUPS)
        ...
        effective_block_id = (raw_block_id - NOPE_GRID_BLOCKS) * GROUPS
        offs = effective_block_id * GROUP_SIZE + tl.arange(0, BLOCK_N)
        mask = offs < DIM_ROPE
