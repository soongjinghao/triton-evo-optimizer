...
def _chunk_cumsum_fwd_kernel(
    ...
    # Fused computation: load, bias add, softplus, clamp in one pipeline
...
def _chunk_cumsum_fwd(dt, A, chunk_size, dt_bias=None, dt_softplus=False, dt_limit=(0.0, float("inf"))):
    ...
    # Dynamic BLOCK_SIZE_H selection based on nheads
    BLOCK_SIZE_H = min(32, triton.next_power_of_2(nheads))
