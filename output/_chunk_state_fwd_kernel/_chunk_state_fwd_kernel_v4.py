...
def _chunk_state_fwd_kernel(
    ...
    BLOCK_SIZE_K: tl.constexpr = 16,  # kept for compatibility, not used
):
    ...
    # Initialize accumulating pointers to avoid k*stride multiplication inside loop
    x_off = x_ptr
    b_off = b_ptr
    dt_off = dt_ptr
    ...
    for k in range(chunk_size_limit):
        ...
        # Advance pointers by their respective strides
