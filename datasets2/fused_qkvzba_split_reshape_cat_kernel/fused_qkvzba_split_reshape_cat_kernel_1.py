...
ALL_DECODER_LAYER_TYPES = {
    "attention": None,  # Qwen3HybridAttentionDecoderLayer not available
    "linear_attention": None,  # Qwen3HybridLinearDecoderLayer not available
}

EntryClass = None  # Qwen3NextForCausalLM not available
