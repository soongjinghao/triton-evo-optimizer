...
# Test function for NPU
def test_reshape_and_cache_npu():
    """Test the NPU version of reshape_and_cache"""
    ...
    # Create slot mapping - some tokens map to valid slots, some to padding
    slot_mapping = torch.cat([
        torch.randint(0, num_blocks * block_size - 10, (num_tokens - 20,), device='npu'),
        torch.full((20,), -1, device='npu')  # Padding tokens
    ])
